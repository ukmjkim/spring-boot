package com.mjkim.springboot.service;
...
import com.mjkim.springboot.model.Survey;
...
public class SurveyService {
	...
	public Question addQuestion(String surveyId, Question question) {
		...
		// toString() equals toString(10), converting the integer to the decimal
		// system.
		// toString(32) means converting to a string to the base-32
		// 26 characters base-32 digits, 32^26 = 2^5^26 = 2^130
		// each character will represent exactly 5 bits.
		// 130 bits can be evenly divided into characters
